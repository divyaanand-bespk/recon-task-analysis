...
- Fit for Pilot requires AI rubrics Pass, Pass@6 below 2, at least one eligible rollout, Argus Main Pass, and an R/P complete step greater than 20. When no completion step is available, more than 20 leading research or planning calls satisfies the R/P gate.
